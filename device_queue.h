...
// Command enqueue retry configuration
#define DEVICE_QUEUE_MAX_RETRIES           3
#define DEVICE_QUEUE_BASE_RETRY_DELAY_MS   1
#define DEVICE_QUEUE_MAX_RETRY_DELAY_MS    10
#define DEVICE_QUEUE_MAX_ATTEMPT_TIMEOUT_MS 1000
